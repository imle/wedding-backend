...
const (
	...
	// Node types.
	TypeBackroomUser = "BackroomUser"
	TypeInvitee      = "Invitee"
	TypeInviteeParty = "InviteeParty"
)

// BackroomUserMutation represents an operation that mutates the BackroomUser nodes in the graph.
type BackroomUserMutation struct {
	config
	op            Op
	typ           string
	id            *int
	...
	oldValue      func(context.Context) (*BackroomUser, error)
	predicates    []predicate.BackroomUser
}

var _ ent.Mutation = (*BackroomUserMutation)(nil)

// backroomuserOption allows management of the mutation configuration using functional options.
type backroomuserOption func(*BackroomUserMutation)

// newBackroomUserMutation creates new mutation for the BackroomUser entity.
func newBackroomUserMutation(c config, op Op, opts ...backroomuserOption) *BackroomUserMutation {
	m := &BackroomUserMutation{
		config:        c,
		op:            op,
		typ:           TypeBackroomUser,
...
// withBackroomUserID sets the ID field of the mutation.
func withBackroomUserID(id int) backroomuserOption {
	return func(m *BackroomUserMutation) {
		var (
			err   error
			once  sync.Once
			value *BackroomUser
		)
		m.oldValue = func(ctx context.Context) (*BackroomUser, error) {
			once.Do(func() {
				if m.done {
					err = fmt.Errorf("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().BackroomUser.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withBackroomUser sets the old BackroomUser of the mutation.
func withBackroomUser(node *BackroomUser) backroomuserOption {
	return func(m *BackroomUserMutation) {
		m.oldValue = func(context.Context) (*BackroomUser, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
func (m BackroomUserMutation) Client() *Client {
...
func (m BackroomUserMutation) Tx() (*Tx, error) {
...
func (m *BackroomUserMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
func (m *BackroomUserMutation) SetUsername(s string) {
	m.username = &s
}

// Username returns the value of the "username" field in the mutation.
func (m *BackroomUserMutation) Username() (r string, exists bool) {
	v := m.username
	if v == nil {
		return
	}
...
// OldUsername returns the old "username" field's value of the BackroomUser entity.
// If the BackroomUser object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *BackroomUserMutation) OldUsername(ctx context.Context) (v string, err error) {
...
func (m *BackroomUserMutation) ResetUsername() {
	m.username = nil
}

// SetPassword sets the "password" field.
func (m *BackroomUserMutation) SetPassword(s string) {
	m.password = &s
}

// Password returns the value of the "password" field in the mutation.
func (m *BackroomUserMutation) Password() (r string, exists bool) {
	v := m.password
	if v == nil {
		return
	}
...
// OldPassword returns the old "password" field's value of the BackroomUser entity.
// If the BackroomUser object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *BackroomUserMutation) OldPassword(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *BackroomUserMutation) ResetPassword() {
	m.password = nil
}

// Op returns the operation name.
func (m *BackroomUserMutation) Op() Op {
	return m.op
}

// Type returns the node type of this mutation (BackroomUser).
func (m *BackroomUserMutation) Type() string {
	return m.typ
}
...
// AddedFields().
func (m *BackroomUserMutation) Fields() []string {
	fields := make([]string, 0, 2)
	if m.username != nil {
		fields = append(fields, backroomuser.FieldUsername)
	}
	if m.password != nil {
		fields = append(fields, backroomuser.FieldPassword)
	}
	return fields
}
...
// schema.
func (m *BackroomUserMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// database failed.
func (m *BackroomUserMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case backroomuser.FieldUsername:
	...
	return nil, fmt.Errorf("unknown BackroomUser field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *BackroomUserMutation) SetField(name string, value ent.Value) error {
	switch name {
	case backroomuser.FieldUsername:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown BackroomUser field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *BackroomUserMutation) AddedFields() []string {
	return nil
}
...
func (m *BackroomUserMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *BackroomUserMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown BackroomUser numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *BackroomUserMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *BackroomUserMutation) FieldCleared(name string) bool {
...
func (m *BackroomUserMutation) ClearField(name string) error {
	return fmt.Errorf("unknown BackroomUser nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *BackroomUserMutation) ResetField(name string) error {
	switch name {
	case backroomuser.FieldUsername:
		m.ResetUsername()
		return nil
...
func (m *BackroomUserMutation) AddedEdges() []string {
...
func (m *BackroomUserMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *BackroomUserMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
func (m *BackroomUserMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *BackroomUserMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
func (m *BackroomUserMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *BackroomUserMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown BackroomUser unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *BackroomUserMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown BackroomUser edge %s", name)
}
