...
func (ec *EventCreate) AddRsvpIDs(ids ...int) *EventCreate {
	ec.mutation.AddRsvpIDs(ids...)
	return ec
}

// AddRsvps adds the "rsvps" edges to the EventRSVP entity.
func (ec *EventCreate) AddRsvps(e ...*EventRSVP) *EventCreate {
	ids := make([]int, len(e))
	for i := range e {
		ids[i] = e[i].ID
	}
	return ec.AddRsvpIDs(ids...)
}
...
func (ec *EventCreate) createSpec() (*Event, *sqlgraph.CreateSpec) {
	...
	if nodes := ec.mutation.RsvpsIDs(); len(nodes) > 0 {
